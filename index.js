...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'ss.qnmlgbsbd.kdns.fr';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZGVjOWYxNDMzMzIwZDIyOGY4MzU0ZGJlYzQ1MWI1MTAiLCJ0IjoiNGEwZTc1Y2MtNzUzMS00NzlhLWE3MzQtNWZkMThkMmJlYmRhIiwicyI6Ik5qQmtZbU5sWXpVdFpHSmhNQzAwWTJOaUxUazJOVFF0Wm1VMVpXVXdOREJoTWpkayJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
const ARGO_PORT = process.env.ARGO_PORT || 54782;            // 固定隧道端口,使用token需在cloudflare后台设置和这里一致
